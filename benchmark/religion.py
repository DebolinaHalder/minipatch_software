...
#%%
df = pd.read_csv('AsianReligionsData/AllBooks_baseline_DTM_Labelled.csv', header=None)
X, y_ = df.iloc[1:, 1:].values, df.iloc[1:,0].values
y = [p[ 0 : p.index("_")] for p in y_]
...
# %%
result_time.to_csv("religion_time_2.csv")
result_accuracy.to_csv("religion_accuracy_2.csv")
# %%
